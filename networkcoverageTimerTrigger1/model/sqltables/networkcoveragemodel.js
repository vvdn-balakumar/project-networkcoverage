...
var objNetworkCoverage = {
    ...
    "NoOfDeltalinkAllocated" : {type: Sequelize.INTEGER(11)},
    "Master_DeltalinkSerialNumber" : { type: Sequelize.STRING(100) },
    "Master_DeltalinkID" :  {type: Sequelize.INTEGER(11)} ,
    "Slave_DeltalinkSerialNumber": { type: Sequelize.STRING(100) },
    "Slave_DeltalinkID" : {type: Sequelize.INTEGER(11)}
}
